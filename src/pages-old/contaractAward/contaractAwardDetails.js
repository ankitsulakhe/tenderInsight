...
class ContractAwardDetails extends Component {
  render() {
    return (
      <div>
        <section className="breadcrumbs">
          <div className="container">
            <div className="d-flex justify-content-between align-items-center">
              <h2>Chemical Tenders Contract Awards</h2>
              <ol>
                <li>
          ...
          <section id="faq" className="faq">
            <div className="container" data-aos="fade-up">
              <div className="section-title sectionList">
                <h3>
                  Contract Awards <span>Information</span>
                </h3>
                <p>
                            ...
                            >
                              <div className="box">
                                ...
                                <p>
                                  ...
                                  Educational Organizations Subordinate.
                                </p>
                              </div>
                            </div>
...
export default ContractAwardDetails;
